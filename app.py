...
def charger_donnees():
    ...
    # Échantillon initial robuste pour éviter que les algorithmes ne plantent au début
    np.random.seed(42)
...
# --- SECTION 1 : FORMULAIRE DE COLLECTE ---
...
# --- PRÉPARATION NUMÉRIQUE POUR LE MACHINE LEARNING ---
# Encodage sécurisé des variables qualitatives
df_ml = df.copy()
...
# --- SECTION 3 : APPRENTISSAGE SUPERVISÉ ---
    ...
    # Définition déterministe de la cible médicale (0 = Sain, 1 = Risque élevé)
...
# --- SECTION 4 : APPRENTISSAGE NON SUPERVISÉ ---
elif choix_menu == "4. Apprentissage Non Supervisé":
    st.header("Apprentissage Non Supervisé : Clustering")
    st.write("**Algorithme de calcul :** K-Means (Partitionnement automatique en 2 groupes distinctes)")
...
# --- SECTION 5 : HISTORIQUE DES DONNÉES ---
